...
Partial Class MasterMaint_PRINT_ALIGN_INIT_Dtl
    ...
    Protected Sub UCAction_DisplayMode() Handles UCAction.DisplayMode
        ...
        Dim _datatable As Data.DataTable = Library.Database.BLL.PrintAlignInit.GetData(MyBase.Key)
        ...
        If _datatable.Rows(0)("Default_Printer") Then
            lblDefaultPrinter.Text = "Yes"
        Else
            lblDefaultPrinter.Text = "No"
        End If
    ...
    Protected Sub UCAction_AddAction() Handles UCAction.AddAction, UCAction.EditAction
        ...
        Dim Company_Code As String = Session("COMPANYCODE").ToString.Trim

        Dim _temp As String = Library.Database.BLL.PrintAlignInit.Maint(MyBase.Key, txtPrinterName.Text, txtTextFont.Text, txtWidthX.Text, txtTextFontSize.Text, _
                                                                          txtWidthY.Text, txtBarcodeFont.Text, txtLengthHeaderX.Text, txtBarcodeFontSize.Text, _
                                                                          txtLengthHeaderY.Text, txtPackCodeX.Text, txtUnitWeightX.Text, txtPackCodeY.Text, _
                                                                          txtUnitWeightY.Text, txtNumPerPackX.Text, txtSlitLotNoX.Text, txtNumPerPackY.Text, txtSlitLotNoY.Text, _
                                                                          txtPC1X.Text, txtGradeX.Text, txtPC1Y.Text, txtGradeY.Text, txtLengthX.Text, txtCoreCodeX.Text, txtLengthY.Text, _
                                                                          txtCoreCodeY.Text, txtThicknessX.Text, txtBarcodeX.Text, txtThicknessY.Text, txtBarcodeY.Text, txtTypeX.Text, _
                                                                          txtTypeY.Text, RadioButton1.Checked, RadioButton2.Checked, Company_Code, CInt(MyBase.Action))
    ...
    Protected Sub UCAction_DeleteAction() Handles UCAction.DeleteAction
        ...
        Dim _temp As String = Library.Database.BLL.PrintAlignInit.Maint(MyBase.Key, txtPrinterName.Text, txtTextFont.Text, txtWidthX.Text, txtTextFontSize.Text, _
                                                                          ...
                                                                          txtPC1X.Text, txtGradeX.Text, txtPC1Y.Text, txtGradeY.Text, txtLengthX.Text, txtCoreCodeX.Text, txtLengthY.Text, _
                                                                          txtCoreCodeY.Text, txtThicknessX.Text, txtBarcodeX.Text, txtThicknessY.Text, txtBarcodeY.Text, txtTypeX.Text, _
                                                                          txtTypeY.Text, RadioButton1.Checked, RadioButton2.Checked, lbCompanyCode.Text, Int(Library.Root.Control.Base.EnumAction.Delete))
    ...
    Protected Sub RadioButton2_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles RadioButton2.CheckedChanged
        Library.Root.Control.MessageCenter.ShowAJAXMessageBox(Me.Page, "Please set Yes on other required printer first before setting to No")
        RadioButton2.Checked = False
    End Sub
