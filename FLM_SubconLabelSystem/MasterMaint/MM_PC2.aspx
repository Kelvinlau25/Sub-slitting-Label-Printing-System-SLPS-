<%@ Page Language="VB" MasterPageFile="~/master/Main.master" AutoEventWireup="false" CodeFile="MM_PC2.aspx.vb" Inherits="MasterMaint_MM_PC2" title="MM_PC2" %>
                ...
                <PagerSettings Visible="False" />
                    <Columns>
                       <asp:TemplateField HeaderStyle-Width="60%" HeaderText="PC2" HeaderStyle-HorizontalAlign="Left" SortExpression="PC2">
                            ...
                            <ItemTemplate>
                                <a target="_self" href="<%# MyBase.GetUrl(EnumAction.View, Eval("ID_MM_PC2")) %>"><%#Eval("PC2")%></a>
                            </ItemTemplate>
                       </asp:TemplateField> 
