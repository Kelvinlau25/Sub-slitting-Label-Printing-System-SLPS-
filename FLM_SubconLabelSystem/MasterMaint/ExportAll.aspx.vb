...
Partial Class Master_Default
    ...
    Public Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Session("SearchField") IsNot Nothing) AndAlso (Session("SearchValue") IsNot Nothing) Then
            SearchField = Session("SearchField")
            SearchValue = Session("SearchValue")
            addCondition = Session("AddCondition")
    ...
    Public Sub CheckBoxUpdate()
        ...
        upd_stat = Library.Database.BLL.LotSlitting.UpdPrintSelAll("1", "Update", SearchField, SearchValue, addCondition, passType)
    ...
    Public Sub CheckBoxInit()
        ...
        upd_stat = Library.Database.BLL.LotSlitting.UpdPrintSelAll("1", "Init", SearchField, SearchValue, addCondition, passType)
        If upd_stat.Equals("1") = False Then
            'MsgBox("Update Print_Sel not successful2")
            'Library.Root.Control.MessageCenter.ShowAJAXMessageBox(Me.Page, "Update Print_Sel not successful")
            Library.Root.Control.MessageCenter.ShowAJAXMessageBox(Me.Page, upd_stat)
        End If
