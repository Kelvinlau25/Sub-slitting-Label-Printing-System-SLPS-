<%@ Page Language="VB" MasterPageFile="~/master/Main.master" enableEventValidation="true" AutoEventWireup="false" CodeFile="MM_COMPANY_Dtl.aspx.vb" Inherits="MasterMaint_MM_COMPANY_Dtl" title="MM_COMPANY_Dtl" %>
 ...
 <asp:Panel ID="Cmodify" runat="server">
    <table class="detailinfo">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtEmail" runat="server" Width="200" ValidationGroup=></asp:TextBox>
