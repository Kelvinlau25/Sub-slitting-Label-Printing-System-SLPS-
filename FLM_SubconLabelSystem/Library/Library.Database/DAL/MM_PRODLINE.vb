...
Namespace DAL
    ...
    Public Class MM_PRODLINE
        ...
        Friend Function Maint(ByVal ID As String, ByVal ProdLine As String, ByVal Desc As String, _
                                     ByVal RecType As String, ByVal UpdatedBy As String, ByVal UpdatedLoc As String) As String
            Maint = "1"
            Try
                With MyBase._cmd
                    .CommandText = "SP_MM_PRODLINE_MAINT"
                    .CommandType = CommandType.StoredProcedure
                    .CommandTimeout = 0
                    ...
                    .Parameters.Add(New SqlParameter("@pDesc", Desc)).Direction = Data.ParameterDirection.Input
