...
Namespace DAL
    ...
    Public Class Company
        ...
        Friend Function Maint(ByVal id As String, ByVal CompanyCode As String, ByVal CompanyName As String, ByVal SlitCode As String, ByVal Address As String, ByVal Telephone As String, _
                                     ByVal Email As String, ByVal RecType As String, ByVal UpdatedBy As String, ByVal UpdatedLoc As String) As String
            Maint = "1"
            Try
                With MyBase._cmd
                    .CommandText = "SP_MM_COMPANY_MAINT"
                    .CommandType = CommandType.StoredProcedure
                    .CommandTimeout = 0
                    ...
                    .Parameters.Add(New SqlParameter("@pCompanyName", CompanyName)).Direction = Data.ParameterDirection.Input
                    .Parameters.Add(New SqlParameter("@pSlitCode", slitCode)).Direction = Data.ParameterDirection.Input
                    .Parameters.Add(New SqlParameter("@pAddress", Address)).Direction = Data.ParameterDirection.Input
                    .Parameters.Add(New SqlParameter("@pTelephone", Telephone)).Direction = Data.ParameterDirection.Input
