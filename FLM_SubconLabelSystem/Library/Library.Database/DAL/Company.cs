...
namespace Library.Database.DAL
{
    ...
    /// Data Access Layer
    /// </summary>
    public class Company : Library.SQLServer.Connection
    {
        public Company() : base("PFR_Label_DB") { }
        ...
        internal DataTable GetData(string ID)
        {
            ...
            base._cmd.CommandText = "SP_MM_COMPANY_SEL";
            base._cmd.CommandType = CommandType.StoredProcedure;
            base._cmd.CommandTimeout = 0;
            base._cmd.Parameters.Clear();
        ...
        internal string Maint(string id, string CompanyCode, string CompanyName, string SlitCode, string Address, string Telephone,
                               string Email, string RecType, string UpdatedBy, string UpdatedLoc)
        {
            string result = "1";
            try
            {
                base._cmd.CommandText = "SP_MM_COMPANY_MAINT";
                base._cmd.CommandType = CommandType.StoredProcedure;
                base._cmd.CommandTimeout = 0;
                base._cmd.Parameters.Clear();
                ...
                base._cmd.Parameters.Add(new SqlParameter("@pCompanyName", CompanyName)).Direction = ParameterDirection.Input;
                base._cmd.Parameters.Add(new SqlParameter("@pSlitCode", SlitCode)).Direction = ParameterDirection.Input;
                base._cmd.Parameters.Add(new SqlParameter("@pAddress", Address)).Direction = ParameterDirection.Input;
                base._cmd.Parameters.Add(new SqlParameter("@pTelephone", Telephone)).Direction = ParameterDirection.Input;
