...
Namespace DAL
    ...
    Public Class PC2
        ...
        Friend Function Maint(ByVal ID As String, ByVal CompanyCode As String, ByVal PC2 As String, ByVal Thickness As String, ByVal Type As String, ByVal Width As String, _
                                ByVal Length As String, ByVal PackCode As String, ByVal Grade As String, _
