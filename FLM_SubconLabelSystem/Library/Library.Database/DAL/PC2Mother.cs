...
namespace Library.Database.DAL
{
    ...
    /// Data Access Layer
    /// </summary>
    public class PC2Mother : Library.SQLServer.Connection
    {
        public PC2Mother() : base("PFR_Label_DB") { }
        ...
        internal DataTable GetData(string ID)
        {
            ...
            base._cmd.CommandText = "SP_MM_PC2_MOTHER_SEL";
            base._cmd.CommandType = CommandType.StoredProcedure;
            base._cmd.CommandTimeout = 0;
            base._cmd.Parameters.Clear();
        ...
        internal string Maint(string ID, string PC2, string Thickness, string Type, string Width,
                               ...
                               string RecType, string UpdatedBy, string UpdatedLoc)
        {
            ...
            try
            {
                base._cmd.CommandText = "SP_MM_PC2_MOTHER_MAINT";
                base._cmd.CommandType = CommandType.StoredProcedure;
                base._cmd.CommandTimeout = 0;
                base._cmd.Parameters.Clear();
                ...
                base._cmd.Parameters.Add(new SqlParameter("@pMachine", Machine)).Direction = ParameterDirection.Input;
