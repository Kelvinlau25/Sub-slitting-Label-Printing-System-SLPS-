...
namespace Library.Database.DAL
{
    ...
    /// Data Access Layer
    /// </summary>
    public class MM_PRODLINE : Library.SQLServer.Connection
    {
        public MM_PRODLINE() : base("PFR_Label_DB") { }
        ...
        internal string Maint(string ID, string ProdLine, string Desc,
                               string RecType, string UpdatedBy, string UpdatedLoc)
        {
            string result = "1";
            try
            {
                base._cmd.CommandText = "SP_MM_PRODLINE_MAINT";
                base._cmd.CommandType = CommandType.StoredProcedure;
                base._cmd.CommandTimeout = 0;
                base._cmd.Parameters.Clear();
                ...
                base._cmd.Parameters.Add(new SqlParameter("@pDesc", Desc)).Direction = ParameterDirection.Input;
