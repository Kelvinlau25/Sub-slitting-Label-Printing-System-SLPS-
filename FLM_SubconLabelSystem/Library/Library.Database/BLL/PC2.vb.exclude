Namespace BLL
    ...
    Public Class PC2
        ...
        Public Shared Function Maint(ByVal ID As String, ByVal CompCode As String, ByVal PC2 As String, ByVal Thickness As String, ByVal Type As String, ByVal Width As String, _
                                 ByVal Length As String, ByVal PackCode As String, ByVal Grade As String, _
                                 ByVal CoreCode As String, ByVal UnitWeight As String, _
                                 ByVal NumPerPack As String, ByVal Remarks As String, ByVal RecType As String) As String
            Using _Dal As New DAL.PC2
                ...
                'Maint = _Dal.Maint(ID, PC2, Thickness, Type, Width, Length, PackCode, Grade, CoreCode, Machine, UnitWeight, NumPerPack, Remarks, RecType, "Admin", System.Web.HttpContext.Current.Request.UserHostAddress.ToString)
                Maint = _Dal.Maint(ID, CompCode, PC2, Thickness, Type, Width, Length, PackCode, Grade, CoreCode, UnitWeight, NumPerPack, Remarks, RecType, str, System.Web.HttpContext.Current.Request.UserHostAddress.ToString)
