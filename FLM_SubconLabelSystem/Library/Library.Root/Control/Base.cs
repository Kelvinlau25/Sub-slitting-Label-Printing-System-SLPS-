    ...
    public abstract class Base : Page
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (this.GridView != null)
            {
                if (this.DeleteControl)
                {
                    ...
                    _field.ItemTemplate = new Library.Root.deletefield(ListItemType.Item);
                ...
                {
                    TemplateField _field = new TemplateField();
                    _field.ItemTemplate = new Library.Root.checkboxfield(ListItemType.Item);
                    _field.ItemStyle.HorizontalAlign = HorizontalAlign.Center;
                    _field.HeaderTemplate = new Library.Root.checkboxfield(ListItemType.Header);
                ...
                {
                    TemplateField _field = new TemplateField();
                    _field.ItemTemplate = new Library.Root.radiobuttonfield(ListItemType.Item);
                    _field.ItemStyle.HorizontalAlign = HorizontalAlign.Center;
                    _field.ControlStyle.Width = 30;
                    _field.ItemStyle.Width = 30;
                    _field.HeaderStyle.Width = 30;
                ...
                {
                    TemplateField _field = new TemplateField();
                    _field.ItemTemplate = new Library.Root.historyfield(ListItemType.Item);
                    _field.ItemStyle.HorizontalAlign = HorizontalAlign.Center;
                    _field.HeaderTemplate = new Library.Root.historyfield(ListItemType.Header);
                    _field.HeaderStyle.HorizontalAlign = HorizontalAlign.Center;
        ...
        private void BindAction()
        {
            if (!string.IsNullOrEmpty(Request.QueryString["action"]))
            {
                ...
                {
                    case 1: this._Action = EnumAction.Add; break;
                    case 3: this._Action = EnumAction.Edit; break;
                    case 5: this._Action = EnumAction.Delete; break;
                    case 7: this._Action = EnumAction.View; break;
                    default: this._Action = EnumAction.None; break;
                }
            }
        }
        ...
        public string DeleteClassName { get { return _DeleteClassName; } set { _DeleteClassName = value; } }

        // 36
        private bool _DeleteConfirmationBox = false;
        public bool DeleteConfirmationBox { get { return _DeleteConfirmationBox; } set { _DeleteConfirmationBox = value; } }

        // 35
        private bool _DetailListingFunction = false;
        public bool DetailListingFunction { get { return _DetailListingFunction; } set { _DetailListingFunction = value; } }

        // 34
        private bool _DeletedVisibleControl = false;
        public bool DeletedVisibleControl { get { return _DeletedVisibleControl; } set { _DeletedVisibleControl = value; } }

        // 33
        private string _DetetedText = "Deleted";
        public string DeletedText { get { return _DetetedText; } set { _DetetedText = value; } }
        ...
        public bool ReturnURLControl { get { return _ReturnURLControl; } set { _ReturnURLControl = value; } }

        // 30
        private bool _DeleteRedirectList = false;
        public bool DeleteRedirectList { get { return _DeleteRedirectList; } set { _DeleteRedirectList = value; } }

        // 29
        private bool _ShowDeletedControl = true;
        public bool ShowDeletedControl { get { return this._ShowDeletedControl; } set { this._ShowDeletedControl = value; } }

        // 28
        private bool _ViewHistoryControl = true;
        public bool ViewHistoryControl { get { return this._ViewHistoryControl; } set { this._ViewHistoryControl = value; } }

        // 27
        private bool _PrintControl = true;
        public bool PrintControl { get { return this._PrintControl; } set { this._PrintControl = value; } }

        // 26
        private string _gvMouseOver = "Highlight(this)";
        public string GridViewRowMouseOver { get { return this._gvMouseOver; } set { this._gvMouseOver = value; } }

        // 25
        private string _gvMouseOUT = "UnHighlight(this)";
        public string GridViewRowMouseOut { get { return this._gvMouseOUT; } set { this._gvMouseOUT = value; } }

        // 24
        private bool _checkcolumn = true;
        public bool GridViewCheckColumn { get { return this._checkcolumn; } set { this._checkcolumn = value; } }

        private bool _CheckBoxPostBack = true;
        public bool GridViewCheckBoxPostBack { get { return this._CheckBoxPostBack; } set { this._CheckBoxPostBack = value; } }

        private bool _radiocolumn = false;
        public bool GridViewRadioColumn { get { return this._radiocolumn; } set { this._radiocolumn = value; } }

        // 23
        private System.Web.UI.WebControls.GridView _gridview = null;
        public System.Web.UI.WebControls.GridView GridView { get { return this._gridview; } set { this._gridview = value; } }

        // 22
        private string _deleteImagePath = "~/Image/delete1.gif";
        public string DeleteImagePath { get { return this._deleteImagePath; } set { this._deleteImagePath = value; } }

        // 21
        private bool _AdvanceControl = true;
        public bool AdvancedControl { get { return this._AdvanceControl; } set { this._AdvanceControl = value; } }

        // 20
        private bool _AddControl = true;
        public bool AddControl { get { return this._AddControl; } set { this._AddControl = value; } }
        ...
        public EnumAction Action { get { return _Action; } }
        ...
        public string SortField { get { return _SortField; } set { _SortField = value; } }
        ...
        public bool ShowDeleted { get { return _ShowDeleted; } set { _ShowDeleted = value; } }

        private string _item1 = string.Empty;
        public string Item1 { get { return Server.UrlDecode(_item1); } set { _item1 = value; } }
        ...
        public string Item3 { get { return _item3; } set { _item3 = value; } }

        private string _item4 = string.Empty;
        public string Item4 { get { return _item4; } set { _item4 = value; } }

        private string _item5 = string.Empty;
        public string Item5 { get { return _item5; } set { _item5 = value; } }

        private string _item6 = string.Empty;
        public string Item6 { get { return _item6; } set { _item6 = value; } }

        private string _item7 = string.Empty;
        public string Item7 { get { return _item7; } set { _item7 = value; } }

        private string _item8 = string.Empty;
        public string Item8 { get { return _item8; } set { _item8 = value; } }

        private string _item9 = string.Empty;
        public string Item9 { get { return _item9; } set { _item9 = value; } }

        private string _item10 = string.Empty;
        public string Item10 { get { return _item10; } set { _item10 = value; } }

        private string _item11 = string.Empty;
        public string Item11 { get { return _item11; } set { _item11 = value; } }

        private string _item12 = string.Empty;
        public string Item12 { get { return _item12; } set { _item12 = value; } }
        ...
        public string ActionDesc
        {
            get
            {
                switch (_Action)
                {
                    ...
                    case EnumAction.None: return string.Empty;
        ...
        public string GenerateList
        {
            get
            {
                return ResolveUrl(this.ListPage) + "?sort=" + (this.SortField == string.Empty ? DefaultSort : this.SortField) +
                    "&dic=" + (this.SortDirection == string.Empty ? "0" : this.SortDirection) +
                    "&page=" + this._Pageno +
                    "&fld=" + Server.UrlEncode(this._SearchField) +
                    "&vl=" + Server.UrlEncode(this._SearchValue) +
                    "&type=" + this._type +
                    "&itm1=" + Server.UrlEncode(this._item1) +
                    "&itm2=" + this._item2 + "&itm3=" + this._item3 + "&itm4=" + this._item4 +
                    "&itm5=" + this._item5 + "&itm6=" + this._item6 + "&itm7=" + this._item7 +
                    "&itm8=" + this._item8 + "&itm9=" + this._item9 +
                    "&itm10=" + this._item10 + "&itm11=" + this._item11 + "&itm12=" + this._item12 +
                    "&dlt=" + this._ShowDeleted +
                    (this._DetailListingFunction ? "&" + DetailListingAdditionalFunction() : string.Empty);
            }
        }
        ...
        private string DetailListingAdditionalFunction()
        {
            switch (Action)
            {
                case EnumAction.Add: return "action=" + (int)EnumAction.Add;
                case EnumAction.Delete: return "?action=" + (int)EnumAction.Delete + "&id=" + (Key == "" ? this.Key : Key);
                case EnumAction.Edit: return "action=" + (int)EnumAction.Edit + "&id=" + (Key == "" ? this.Key : Key);
                case EnumAction.View: return "action=" + (int)EnumAction.View + "&id=" + (Key == "" ? this.Key : Key);
                default: return string.Empty;
            }
        }
        ...
        public string GetUrl(EnumAction action, string key = "")
        {
            ...
            switch (action)
            {
                ...
                case EnumAction.Delete:
                    tempurl = this.DeleteRedirectList
                        ? this.GenerateList + "&action=" + (int)EnumAction.Delete + "&id=" + (key == "" ? this.Key : key)
                        : ResolveUrl(this.DetailPage + "?action=" + (int)EnumAction.Delete + "&id=" + (key == "" ? this.Key : key));
                    break;
        ...
        public string SetupKey { get { return _SetupKey; } set { _SetupKey = value; } }

        public abstract string DisplayTitle { get; }

        private bool _FunctionControl = true;
        public bool FunctionControl { get { return _FunctionControl; } set { _FunctionControl = value; } }

        private bool _DeleteControl = true;
        public bool DeleteControl { get { return _DeleteControl; } set { _DeleteControl = value; } }

        private bool _customTitle = false;
        public bool CustomTitle { get { return _customTitle; } set { _customTitle = value; } }
        ...
        {
            string[] idlist = this.Item1.Split(',');
            if (idlist.Contains(id) == false) return;
        ...
        protected void gridview_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                if (this.DeleteControl && this.RecordTypeColumn > -1)
                {
        ...
        {
            return this.DeleteClassName != string.Empty ? "class='" + this.DeleteClassName + "'" : string.Empty;
        }
        ...
        private void gridview_rowcreated(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow && this.GridView != null)
            {
                ...
                if (this.ViewHistoryControl)
                {
                    ((Literal)e.Row.FindControl("ltrhisitem")).Text = string.Format(
                        "<a target='_blank' href='{0}'>View</a>",
                        this.GetUrl(EnumAction.History, Convert.ToString(this.GridView.DataKeys[e.Row.RowIndex][0])));
                }
            }
