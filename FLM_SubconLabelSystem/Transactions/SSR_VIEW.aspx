    ...
    <script type="text/javascript" language="javascript">
        $(function () {
           $(".txtDate").datepicker({
              ...
              buttonImage: '/PFRLabelIssuing/image/icon_cal.png',
              numberOfMonths: 1,
              dateFormat: 'dd/mm/yy'
            });
            $(".txtETD").datepicker({
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td><h3>Sub-Slitting Request - View</h3></td>
    </tr>
    </table>
    <br/>
    ...
    <tr>
        ...
        <td class="style4" ><asp:DropDownList ID="ddlReqStat" runat="server" AutoPostBack="true"></asp:DropDownList></td>
        ...
        <td class="style12"><asp:DropDownList ID="ddlVenStat" runat="server"></asp:DropDownList></td>
    </tr>
