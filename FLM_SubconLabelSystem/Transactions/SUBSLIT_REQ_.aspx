<%@ Page Language="VB" MasterPageFile="~/master/Main.master" AutoEventWireup="false" CodeFile="SUBSLIT_REQ_.aspx.vb" Inherits="Transactions_SubSlitRequest" title="Sub_Slitting_Request" %>

<script runat="server">

    Protected Sub txtRefNo_TextChanged1(sender As Object, e As EventArgs)
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        ...
        <td class="style4"><asp:TextBox ID="txtRefNo" ClientIDMode="Static" runat="server" ></asp:TextBox>
            <asp:TextBox ID="txtSubReqId" runat="server" Visible="false"></asp:TextBox></td>
    </tr>
        <tr>
    ...
    <tr>
       ...
       <asp:TextBox ID="ddlPC1" runat="server" CssClass="pc1" style="width:94%;"></asp:TextBox>
        ...
        <td >
            ...
            <input id="btnPC2Mother" runat="server" onclick="popupwindow('pc2mother','lblpc2mother');"
            type="button" value="..."/>
            <asp:Button ID="btnpc2" runat="server" Text="btnddlpc2" CssClass="btnpc2" Style ="display:none"/></td>
        <td ><asp:TextBox ID="txtQty" runat="server" AutoPostBack="true" style="width:90%"></asp:TextBox></td>
        <td style="text-align:right><asp:Label ID="lblUnitWeight" runat="server"></asp:Label></td>
        <td style="text-align:right><asp:Label ID="lblTotWeight" runat="server"></asp:Label></td>
        <td style="text-align:right><asp:Label ID="lblSubSlit" runat="server"></asp:Label></td>
        <td><asp:TextBox ID="txtETD" runat="server" CssClass="txtETD" style="width:80%"></asp:TextBox></td>
        <td><asp:TextBox ID="txtETA" runat="server" CssClass="txtETA" style="width:80%"></asp:TextBox></td> 
    </tr>
    </table>
  ...
  <asp:GridView ID="grdChild" runat="server" AutoGenerateColumns="False" Width="100%" OnRowDataBound="OnRowDataBound" OnRowDeleting="OnRowDeleting">
            <PagerSettings Visible="False" />
            <Columns>
          
                <asp:ButtonField ButtonType="Link" CommandName="DELETE" HeaderText="DELETE" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%" Text="&lt;img src='../image/delete.gif' /&gt;">           
                ...
                <asp:TemplateField HeaderText="PC2" ItemStyle-Width="11%">
                    <ItemTemplate>      
                        <asp:TextBox ID="ddlPC2Child" runat="server" CssClass='<%# Container.DataItemIndex + 1 & " no_type" %>' Width="85%"></asp:TextBox> 
                        <input id="btnPC2Mother" runat="server" onclick='<%# "popupwindow(""" & Container.DataItemIndex + 1 & """,""lblpc2mother"");" %>' type="button" value="..."/>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:GridView ID="grdList" DataKeyNames="REFNO" EnableViewState="false" 
            ...
            <Columns>
                ...
                <asp:RadioButton ID="RadioButton1" runat="server" 
                    Visible='<%#IIf(Eval("CHK").ToString.Equals("1"), "True", "False")%>' oncheckedchanged="RadioButton1_CheckedChanged" 
                        Autopostback="true"/>                       
         ...
         <table width="90%" style="height:100%;" border="0" >
            ...
            <tr>
                <td width="10%" align="center"><asp:LinkButton ID="btnEdit" runat="server">Edit</asp:LinkButton></td>
                <td width="10%" align="center"><asp:LinkButton ID="btnDelete" runat="server" 
                        onclientclick="return confirm('Are you sure to delete the selected PC2 Mother/Child records?');">Delete</asp:LinkButton></td>
                <td width="10%"></td>
                <td width="10%"></td>
                <td width="10%"></td>
                <td width="10%"></td>
    ...
    <table width="90%" style="height:100%;" border="0" >
            <tr>
                ...
                <td width="10%" class="style12"></td>
                <td width="10%" class="style12"></td>
                <td width="15%" align="center" class="style12"><asp:Button ID="Submit_Button" runat="server"  
                    Text="Submit" Width="116px" /></td>
                <td width="15%" align="center" class="style12"> <asp:Button ID="Cancel_Button" runat="server"  
                    Text="Cancel" Width="116px" /></td>
            </tr>
            <tr><td colspan='9'>&nbsp;</td></tr>
